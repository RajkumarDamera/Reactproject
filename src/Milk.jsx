...
function Milk() {
  ...
  return (
    <div className="container my-4">
      <h2 className="text-center text-primary fw-bold mb-4">🥛 Fresh Milk & Dairy Products</h2>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="d-flex justify-content-center mb-4 gap-2 flex-wrap">
            <button className="btn btn-outline-primary" onClick={() => handlePriceFilter(0, 100)}>0–100 Rs</button>
            <button className="btn btn-outline-primary" onClick={() => handlePriceFilter(101, 200)}>101–200 Rs</button>
            <button className="btn btn-outline-primary" onClick={() => handlePriceFilter(201, 500)}>201–500 Rs</button>
          ...
          <div className="row row-cols-1 row-cols-md-4 g-4">
            {currentItems.map((item) => (
              <div key={item.id} className="col">
                <div className="card milk-card h-100 position-relative shadow-sm hover-card">
                  {/* Wishlist Button */}
                  <button
                  ...
                  <img src={item.Imageurl} className="card-img-top milk-img rounded-top" alt={item.name} />
                  <div className="card-body d-flex flex-column">
                    ...
                    <button className="btn btn-primary mt-auto rounded-pill shadow-sm" onClick={() => handleAddToCart(item)}>
                      Add To Cart 🛒
                    </button>
                  </div>
                </div>
